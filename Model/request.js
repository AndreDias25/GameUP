...
xboxContentLi.addEventListener("click", function(){
    ...
    Promise.all(promises)
      ...
      <div id="cardGame${i}" class="cardGame">
          ...
          <span id="notasCard${i}" class="notasCard" style="color:${arrayJogosXbox[i].metacritic <= 25 ? 'red' : arrayJogosXbox[i].metacritic <= 50 ? 'orange' : arrayJogosXbox[i].metacritic <= 75 ? 'yellow' : 'green'}; border:${arrayJogosXbox[i].metacritic <= 25 ? '2px solid red' : arrayJogosXbox[i].metacritic <= 50 ? '2px solid orange' : arrayJogosXbox[i].metacritic <= 75 ? '2px solid yellow' : '2px solid green'};">${arrayJogosXbox[i].metacritic}</span>
  ...
  mainContent.style.display = "none";
    ...
    Promise.all(promises)
      ...
      <div id="cardGame${i}" class="cardGame">
          ...
          <span id="notasCard${i}" class="notasCard" style="color:${arrayPlayJogos[i].metacritic <= 25 ? 'red' : arrayPlayJogos[i].metacritic <= 50 ? 'orange' : arrayPlayJogos[i].metacritic <= 75 ? 'yellow' : 'green'}; border:${arrayPlayJogos[i].metacritic <= 25 ? '2px solid red' : arrayPlayJogos[i].metacritic <= 50 ? '2px solid orange' : arrayPlayJogos[i].metacritic <= 75 ? '2px solid yellow' : '2px solid green'};">${arrayPlayJogos[i].metacritic}</span>
  ...
  outrasCategorias.style.display = "block";
    ...
    Promise.all(promises)
      ...
      <div id="cardGame${i}" class="cardGame">
          ...
          <span id="notasCard${i}" class="notasCard" style="color:${arrayNintendoJogos[i].metacritic <= 25 ? 'red' : arrayNintendoJogos[i].metacritic <= 50 ? 'orange' : arrayNintendoJogos[i].metacritic <= 75 ? 'yellow' : 'green'}; border:${arrayNintendoJogos[i].metacritic <= 25 ? '2px solid red' : arrayNintendoJogos[i].metacritic <= 50 ? '2px solid orange' : arrayNintendoJogos[i].metacritic <= 75 ? '2px solid yellow' : '2px solid green'};">${arrayNintendoJogos[i].metacritic}</span>
  ...
  outrasCategorias.style.display = "block";
    ...
    Promise.all(promises)
      ...
      <div id="cardGame${i}" class="cardGame">
          ...
          <span id="notasCard${i}" class="notasCard" style="color:${arrayPCJogos[i].metacritic <= 25 ? 'red' : arrayPCJogos[i].metacritic <= 50 ? 'orange' : arrayPCJogos[i].metacritic <= 75 ? 'yellow' : 'green'}; border:${arrayPCJogos[i].metacritic <= 25 ? '2px solid red' : arrayPCJogos[i].metacritic <= 50 ? '2px solid orange' : arrayPCJogos[i].metacritic <= 75 ? '2px solid yellow' : '2px solid green'};">${arrayPCJogos[i].metacritic}</span>
