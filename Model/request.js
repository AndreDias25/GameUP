...
xboxContentLi.addEventListener("click", function(){
    ...
    let cardsXbox = `<div class="card">
    <div id="cardGame2" class="cardGame">
        <img id="imgCardGame2"  src="https://via.placeholder.com/170x170" alt="" class="imgCard">
        <span id="plataformas2" class="plataformas">
        ...
        <span id="notasCard2" class="notasCard">8.0</span>
        <p id="nameGame2" class="nameCard">Title</p>
    </div>`;

    outrasCategorias.innerHTML = cardsXbox;
})
